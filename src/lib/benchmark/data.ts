...
// All figures sourced from INE, DREM, SREA, Banco de Portugal, HotStats, BEONx, Horwath HTL, AHP, JLL, HVS, CBRE, HOTREC, EU BEMP, Shiji ReviewPro
...
export const REGIONS: Record<string, Region> = {
  "grande-lisboa": {
    ...
    watchouts: ["Lisbon plateau confirmed by AHP — limited rate-rise headroom", "High USD/international exposure (USA 16.8% top market)", "Airport capacity constrains volume growth"]
  },
  "madeira": {
    name: "Madeira",
    ...
    watchouts: ["High German market exposure (23.8%)", "Wage costs higher (regional min wage €980 vs €920 mainland)", "Limited new supply could pressure rates"]
  },
  "algarve": {
    name: "Algarve",
    ...
    watchouts: ["Extreme seasonality 8.5x (Aug vs Jan)", "Heavy UK/GBP exposure (35.9% top market) — Brexit/currency risk", "New supply pressure — competitive ADR risk"]
  },
  "acores": {
    name: "Açores",
    ...
    watchouts: ["Air connectivity in low season constrains demand", "Wage costs higher (regional min wage €966)", "Labor shortages frequently flagged by sector"]
  },
  "norte": {
    ...
    watchouts: ["24 new hotels in pipeline — supply pressure ahead", "Lower ALOS (~2.1 nights) limits room-revenue uplift", "Q1 weather can drag shoulder season"]
  },
  "setubal": {
    ...
    watchouts: ["Limited international airline access", "Seasonal staffing — coastal demand spikes", "Watch for over-pricing as Lisbon plateaus"]
  },
  "alentejo": {
    name: "Alentejo",
    ...
    watchouts: ["Lowest occupancy nationally (41-42%) — fixed-cost leverage critical", "Short ALOS (1.9 nights) constrains operational efficiency", "High seasonality 5.0x — winter staffing challenge"]
  },
  "oeste-vale-tejo": {
    ...
    watchouts: ["Shortest ALOS in Portugal (~1.7 nights) — high turnover costs", "Lowest ADR (~€84) limits absolute revenue", "Limited brand recognition for premium positioning"]
  },
  "centro": {
    name: "Centro",
    ...
    watchouts: ["Lowest occupancy and shortest ALOS in Portugal", "Cooling demand signals in late 2025 — monitor closely", "Limited brand pipeline reduces market visibility"]
  }
};
